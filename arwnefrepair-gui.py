...
class ARWNEFRepairWorker(QThread):
    ...
    def repair_arw_nef(self, encrypted_file, reference_file, output_file):
...
class ARWNEFRepairApp(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("ARW/NEF Repair Tool")
    ...
    def browse_reference_file(self):
        reference_file, _ = QFileDialog.getOpenFileName(self, "Select Reference File", "", "ARW/NEF Files (*.ARW *.NEF)")
        if reference_file:
    ...
    def repair_files(self):
        ...
        self.worker = ARWNEFRepairWorker(reference_file_path, encrypted_folder_path, convert_to_tiff, self.convert_folder)
